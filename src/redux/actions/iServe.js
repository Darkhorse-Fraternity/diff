...
export const ISERVE_PAGE_CHANGE = 'ISERVE_PAGE_CHANGE'
...
export function pageChange(page:number,replytype:string,iCommitID:string):Object{
  return {
    type:ISERVE_PAGE_CHANGE,
    page,
    replytype,
    iCommitID,
  }
