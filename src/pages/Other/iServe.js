...
import {iServeListLoad, iServeListLoadMore, indexChange} from '../../redux/actions/iServe'
...
//底部button
    ...
    shouldComponentUpdate(nextProps: Object) {
        return !immutable.is(this.props.intro, nextProps.intro) || !immutable.is(this.props.loadStatu, nextProps.loadStatu) || !immutable.is(this.props.dataSource, nextProps.dataSource);
    }
            ...
            <View style={[styles.row]}>
             ...
             ()=>{
                ...
                <TouchableOpacity
                    ...
                    onPress={()=>{
                if(data.statu == 'wait'){
                  this.props.indexChange(rowID,type,data.objectId)
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        indexChange: (page: number, type: string, id: string)=> {
            dispatch(indexChange(page, type, id))
        },
