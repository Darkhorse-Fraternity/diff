...
class introDetail extends Component {
    ...
    __renderReply(): ReactElement<any> {
        const replyType = this.props.scene.route.type
    ...
    render(): ReactElement<any> {
        const commitType = this.props.state.get('type')
        ...
        return (
            ...
            <ScrollView style={styles.containerStyle}>
                {statu == 'done' && this.__renderRating()}
...
const mapStateToProps = (state) => {
    const data = state.iCommit.get('data')
    const index = state.iCommit.get('index')
