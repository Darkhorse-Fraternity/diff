...
class iReply extends Component {
    ...
    shouldComponentUpdate(nextProps: Object) {
        return !immutable.is(this.props.state, nextProps.state) || !immutable.is(this.props.uris, nextProps.uris) || !immutable.is(this.props.content, nextProps.content);
    }
    ...
    render(): ReactElement<any> {
        const type = this.props.replyType
        return (
...
const mapStateToProps = (state) => {
    ...
    const index = state.iServe.get('index')

    return {
        state: data.get(index),
        replyType:state.iServe.get('type'),
